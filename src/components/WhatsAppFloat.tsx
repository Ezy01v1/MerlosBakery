...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-rose text-cream shadow-soft transition-transform duration-300 hover:scale-110 sm:bottom-8 sm:right-8"
    >
