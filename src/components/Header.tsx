      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center">
          <button
            ...
            className="text-rose-deep md:hidden"
          ...
          <nav className="hidden md:flex md:items-center md:gap-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="font-sans text-sm font-medium uppercase tracking-wide text-rose-deep transition-colors hover:text-rose"
              >
                {link.label}
              </a>
            ))}
        ...
        <a href="#top" className="flex-shrink-0 text-center">
          <span className="font-display text-xl font-semibold tracking-wide text-rose-deep sm:text-2xl">
        ...
        <div className="flex flex-1 justify-end">
          <a
            ...
            className="hidden items-center gap-2 rounded-full bg-rose px-4 py-2 text-sm font-semibold text-cream shadow-soft transition-transform hover:scale-105 sm:flex"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center rounded-full bg-rose p-2 text-cream sm:hidden"
